        ...
        while (x == 'y') {
            switch (islem) {
                ...
                case 2 -> {
                    ...
                    int sayi = scan.nextInt();
                    int index = numbersList.indexOf(sayi);
                ...
                default -> System.out.println("Bir hata olustu 'y' tusuna basarak tekrar deneyiniz.");
            }
